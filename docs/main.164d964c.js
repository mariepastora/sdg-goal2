...
module.exports = "/c92fb1d4e9062cdef28f0165851e9e44.csv";
...
(function () {
    ...
    function ready(undernourished, stunting) {
        ...
        .style('margin-top', 50 + 'px').style('position', 'relative').classed('cube', true).append('div').style('width', function (d) {
            return sizeScale(10.6) + 'px';
        }).style('height', function (d) {
            return sizeScale(10.6) + 'px';
        }).style('margin-top', function (d) {
            return sizeScale(+d.percentage) - sizeScale(10.6) + 'px';
        })
        //.style('margin-right', 10 + 'px')
        .classed('world-div', true)
        // appending text div
        .append('div').style('width', function (d) {
            if (sizeScale(+d.percentage) < sizeScale(10.6)) {
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","js/main.js"], null)
//# sourceMappingURL=/main.164d964c.map